...
EasyStar.js = function() {
	...
	this.findPath = function(startX, startY ,endX, endY, callback) {
		...
		/*
		trace(this, "findPath >>>>>>>>>>>>>>>>>");
		trace(this, "grid: " + collisionGrid.length + " X " + collisionGrid[0].length);
		trace(this, "start: " + startX + " X " + startY + " |:| end: " + endX + " X " + endY);
		trace(this, "1. " + String(startX < 0));
		trace(this, "2. " + String(startY < 0));
		trace(this, "3. " + String(endX < 0));
		trace(this, "4. " + String(endX < 0));
		trace(this, "5. " + String(startX > collisionGrid[0].length-1));
		trace(this, "6. " + String(startY > collisionGrid.length-1));
		trace(this, "7. " + String(endX > collisionGrid[0].length-1));
		trace(this, "8. " + String(endY > collisionGrid.length-1));
		*/
